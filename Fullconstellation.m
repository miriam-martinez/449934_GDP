...
if flag == 1
    ...
    coord_sat(1,1:56) = a(1).* (cosRAAN.* costheta(:,1)' - sinRAAN.* sintheta(:,1)'.* cosi(1));
    coord_sat(2,1:56) = a(1).* (sinRAAN.* costheta(:,1)' + cosRAAN.* sintheta(:,1)'.* cosi(1));
    coord_sat(3,1:56) = a(1).* sintheta(:,1)'.* sini(1);
    
    coord_sat(1,57:112) = a(2).* (cosRAAN.* costheta(:,2)' - sinRAAN.* sintheta(:,2)'.* cosi(2));
    coord_sat(2,57:112) = a(2).* (sinRAAN.* costheta(:,2)' + cosRAAN.* sintheta(:,2)'.* cosi(2));
    coord_sat(3,57:112) = a(2).* sintheta(:,2)'.* sini(2);
